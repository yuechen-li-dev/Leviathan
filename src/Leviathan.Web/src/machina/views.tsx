...
import {
  ...
  BookingHeaderView,
  BookingMobileCalendarCardView,
  BookingMobileConfirmFooterView,
  BookingMobileHeaderView,
  BookingMobileIntakeCardView,
  BookingMobileSlotsCardView,
  BookingMobileStepStatusView,
  BookingMobileSummaryCardView,
...
export const viewRegistry = {
  ...
  bookingMobileHeader: BookingMobileHeaderView,
  bookingSummaryPanel: BookingSummaryPanelView,
  bookingMobileSummaryCard: BookingMobileSummaryCardView,
  bookingMobileStepStatus: BookingMobileStepStatusView,
  bookingMainHeader: BookingMainHeaderView,
  bookingCalendarRegion: BookingCalendarRegionView,
  bookingMobileCalendarCard: BookingMobileCalendarCardView,
  bookingSlotsRegion: BookingSlotsRegionView,
  bookingMobileSlotsCard: BookingMobileSlotsCardView,
  bookingMobileIntakeCard: BookingMobileIntakeCardView,
  bookingFooterSummary: BookingFooterSummaryView,
  bookingMobileConfirmFooter: BookingMobileConfirmFooterView,
};
