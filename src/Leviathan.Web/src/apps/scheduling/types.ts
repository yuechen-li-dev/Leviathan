...
export type Booking = { id: EntityId; providerId?: EntityId; serviceId?: EntityId; resourceId?: EntityId; status: string; customer: { name: string; email: string; phone?: string; notes?: string }; range?: { startsAtUtc: string; endsAtUtc: string; timeZoneId: string }; cancellationReasonCode?: string; cancellationMessage?: string; cancellationActor?: string; cancellationPolicyResult?: string; paymentStatus?: string; paymentPolicyLabel?: string; paymentReference?: string; notificationPolicyLabel?: string; notificationSummary?: NotificationSummary; rescheduledToBookingId?: string; rescheduledFromBookingId?: string };
...
export type SchedulingLifecycleSummary = { workflowState: string; status: string; lastDecisionCode?: string; lastAuditEventId?: string; checkpointExists?: boolean; checkpointPath?: string; paymentStatus?: string; notificationSummary?: NotificationSummary };
