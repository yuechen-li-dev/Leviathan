...
public sealed record Booking(BookingId Id, ProviderId ProviderId, ServiceId ServiceId, ResourceId ResourceId, CustomerContact Customer, ZonedTimeRange Range, string Status, string PolicySnapshot, DateTimeOffset CreatedAt, DateTimeOffset UpdatedAt, DateTimeOffset ConfirmedAt, DateTimeOffset? CancelledAt);
