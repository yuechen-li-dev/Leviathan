...
public sealed record BookableSlotDto(string ProviderId, string ServiceId, string ResourceId, DateTimeOffset StartsAtUtc, DateTimeOffset EndsAtUtc, string TimeZoneId, string DisplayLabel);
