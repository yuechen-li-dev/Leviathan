...
{
    /// <inheritdoc />
    public partial class TelosX0IdentityProjects : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstalledBy = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Installations_Accounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentRevisionId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Projects_Installations_AppInstallationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Installations_AccountId_AppId",
                table: "Installations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_AccountId_AppInstallationId_Status",
                table: "Projects",
                columns: new[] { "AccountId", "AppInstallationId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Projects_AppInstallationId",
                table: "Projects",
